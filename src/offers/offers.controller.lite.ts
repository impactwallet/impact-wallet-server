import { Body, Controller, HttpCode, HttpStatus, NotFoundException, Param, Patch, Post, Req, ValidationPipe } from '@nestjs/common';
...
export class OffersControllerLite {
  ...
  @Param('orgId') orgId: string,
    ...
    return this.offerServiceLite.updateOfferStatus(org, offerId, body, account);
  }
}